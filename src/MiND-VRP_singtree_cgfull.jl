...
function main()
    ...
    ioStream = open(joinpath(output_dir, string(trial_id) * "_MetST_BFCG.csv"), "w")
    ...
    write(ioStream, join([trial_id, "BFCG", LB, UB, alg_time, precomp_time_sp, num_cuts, numSols, numSolved, timePost], ",") * "\n")
